...
{comp.registration_start && (
  <p>报名：{formatDate(comp.registration_start)} - {comp.registration_end ? formatDate(comp.registration_end) : '无结束'}</p>
)}
{comp.withdrawal_deadline && <p>退赛截止：{formatDate(comp.withdrawal_deadline)}</p>}
              </div>
